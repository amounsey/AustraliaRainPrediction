...
kableExtra::kable_styling(knitr::kable(cv_mod_roc$results[,1:3],booktabs=T,caption ='Optimal Hyperparameter Selection Using 10-fold nested Cross Validation'),latex_options = 'hold_position')

```

```{r logistic_ncvExpected,echo=FALSE,warning=F,message=FALSE}
